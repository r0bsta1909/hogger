...
local table93 = {
  ...
  { 5,   600,  72,  3, 1, 0, 10 },
  { 10, 1200, 144,  3, 2, 1, 11 },
  { 20, 2400, 288,  4, 3, 2, 14 },
  { 40, 4800, 576,  6, 5, 5, 20 },
}
...
T.near(M.eat_dmg_threshold(10), 60, "9.2 Fress-Schadensschwelle N=10")
T.near(M.eat_dmg_threshold(40), 240, "9.2 Fress-Schadensschwelle N=40")
