...
| **Schurke** | Mensch, Zwerg, Nachtelf, Gnom | Finsterer Stoß: 5 Schaden, 40 Energie, +1 Combopunkt | Ausweiden: 4/8/12/16/20 Schaden bei 1–5 CP, 30 Energie | Verstohlenheit: unsichtbar, 60 % Tempo, Hogger ignoriert; bricht beim Angriff. **Nur außerhalb des Kampfes anzuschalten** (Runde 14, #169 — vorher jederzeit mitten im Getümmel; im Kampf: „Das geht nur ausserhalb des Kampfes.", ohne GCD-Verbrauch), Ausschalten geht immer, und sie setzt **keine** Aggro zurück: wer auf der Bedrohungsliste steht, bleibt drauf. Per F10 abschaltbar (`rogue_stealth_enabled`). **Dazu Slot 4: Tritt** (Runde 12, #140) — unterbricht Hoggers Fresskanal, 25 Energie, 10 s Cooldown, Nahkampf-Reichweite, off-GCD, kein Schaden. Taste 4; greift nur während des Kanals (sonst „Hogger frisst gerade nicht.", der Cooldown bleibt unberührt) | **DIE Unterbrecher-Klasse: der Tritt ist die EINZIGE Fress-Unterbrechung im Spiel.** Ohne Schurken frisst Hogger durch — jede Klassenverteilung ist erlaubt, diese Konsequenz gehört dazu (Rob, Runde 12) |
...
| **Hexenmeister** | Mensch, Gnom | Schattenblitz: 2,0 s Cast, 8 Schaden, 25 Mana | Wichtel beschwören: 3 s Cast, 30 Mana; Wichtel: 15 HP, Feuerblitz 2 Schaden/2 s, zieht kurz Aggro | **Blutpakt** (passiv, Runde 13, #159): solange der Wichtel lebt, +10 % Maximal-HP für alle Spieler in 200 px um ihn. Kein Gratis-Heil — nur der Deckel steigt; Verlassen/Wichteltod klemmt zurück | Pseudo-Tank-Pet kauft Sekunden — und sein Umkreis macht den Raid zäher |
| **Druide** | Nachtelf | Zorn: 1,5 s Cast, 6 Schaden, 20 Mana | Heilende Berührung: 3,0 s Cast, heilt 30, 35 Mana | **Gnarlwurzeln** (Runde 13, #158): wurzelt das Mob-/Add-Ziel 5 s fest, 15 s Cooldown, 10 Mana, instant. **Hogger ist immun** („Immun."), Schaden bricht die Wurzeln | Hybrid: Schaden ODER Heals — und der Geleitschutz des Anmarschs |
...
**F10-Schalter (Runde 13, erweitert Runde 14):** Die fünf neuen Fähigkeiten (Handauflegung, Machtwort: Schild, Totstellen, Gnarlwurzeln, Blutpakt) **und die Verstohlenheit** (`rogue_stealth_enabled`, #169) sind **einzeln per F10 abschaltbar** (`*_enabled`-Parameter): der Button verschwindet aus der Leiste, die Taste tut nichts, der Host verwirft. Tritt und Spott (Runde 12) sind fest — der Tritt ist die einzige Fress-Unterbrechung, ihn abzuschalten hieße, die Mechanik zu töten.
...
|---|---|---|
| **HP** | 3 × N² + 620 × N − 1.600 (mild quadratisch seit Runde 6, #96; slope 560 → 620 in Runde 13 als Ausgleich für die fünf neuen Klassen-Fähigkeiten), mindestens 120 × N | N=5: 1.575 · N=10: 4.900 · N=40: 28.000 — der Sockel bildet den Kleingruppen-Overhead ab, der quadratische Term ersetzt die gestrichene N-Skalierung der Todesstrafe (sonst rollen große Raids per Materialschlacht drüber); die Untergrenze fängt Wartelobbys unter der Design-Spanne (N<3) ab |
...
|---|---|---|---|---|---|
| Hogger HP | max(3 × N² + 620 × N − 1.600; 120 × N) — Runde 13 | 1.575 | 4.900 | 12.000 | 28.000 |
| Fress-Heilung/Kanal | 12 % Max-HP | 189 | 588 | 1.440 | 3.360 |
...
| 2 — Sim | 17.2 komplett | F1–F6 Pass/Fail, Uptime-Korridor, Klassenverteilung | **Richtungstest ~2 min** (`--quick --jobs 10`) bei Balancing-PRs; Vollmatrix ~30 min nur vor Releases oder auf Ansage (ADR 004) |
