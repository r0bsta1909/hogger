...
**F10-Schalter (Runde 13):** Die fünf neuen Fähigkeiten (Handauflegung, Machtwort: Schild, Totstellen, Gnarlwurzeln, Blutpakt) sind **einzeln per F10 abschaltbar** (`*_enabled`-Parameter): der Button verschwindet aus der Leiste, die Taste tut nichts, der Host verwirft. Tritt und Spott (Runde 12) sind fest — der Tritt ist die einzige Fress-Unterbrechung, ihn abzuschalten hieße, die Mechanik zu töten.
